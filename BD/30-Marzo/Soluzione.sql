...
-- ESERCIZIO 2
SELECT DISTINCT
	DocentiCorsi.Dipartimento, count(DISTINCT DocentiCorsi.IdD), count(DocentiCorsi.NumeroCorsi), sum(DocentiCorsi.NumStudenti)
FROM
...
WHERE
	ACAC.NumStudenti > ACAC.Capienza
...
WHERE
	D1.Cognome = D2.Cognome AND D1.IdD < D2.IdD
